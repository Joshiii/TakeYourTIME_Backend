     ...
     //   [DllImport("user32.dll", CharSet = CharSet.Auto)]
       // private static extern bool //messagebeep(uint type);
        ...
        private CustomMessageBox()
        {
            ...
            this.BackColor = Color.FromArgb(45, 45, 47);
            ...
            _lblTitle.Font = new System.Drawing.Font("Segoe UI Light", 18);
            _lblTitle.Dock = DockStyle.Top;
            _lblTitle.Height = 50;

            _lblMessage = new Label();
            _lblMessage.ForeColor = Color.White;
            _lblMessage.Font = new System.Drawing.Font("Segoe UI Light", 10);
            ...
            _plFooter.BackColor = Color.FromArgb(52, 73, 94);
            _plFooter.Height = 80;
        ...
        static void timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                DialogResult result = CustomMessageBox.Show("OK", "MLS", CustomMessageBox.Buttons.OK, CustomMessageBox.Icon.Question, CustomMessageBox.AnimateStyle.FadeIn);
            }
        ...
        private static void InitButtons(Buttons buttons)
        {
            ...
            foreach (Button btn in _msgBox._buttonCollection)
            {
                ...
                btn.Font = new System.Drawing.Font("Segoe UI Light", 8);
        ...
        private static Size MessageSize(string message)
        {
            ...
            SizeF size = g.MeasureString(message, new System.Drawing.Font("Segoe UI Light", 10));
